  ...
  return (
    <>
      <div className="h-auto w-auto flex-col lg:flex-row flex bg-[#FBFBFB] justify-center">
        <div className="bg-customYellow mt-10 ms-0  lg:mt-36 w-full lg:w-[542px] h-[551px] lg:h-auto rounded-2xl flex justify-center items-center">
          <img
            src={HOJ}
        ...
        <div className="ml-0 px-10  lg:ml-24  mt-10 lg:mt-64 w-full lg:w-[500px]">
          ...
          <button
            type="button"
            className="mt-8 animate-pulse shadow-2xl shadow-customYellow text-white bg-customYellow hover:bg-customYellow focus:ring-4 focus:outline-none font-medium rounded-lg text-sm lg:text-base px-5 py-2.5 lg:py-3 text-center inline-flex items-center dark:hover:bg-customYellow dark:focus:ring-customYellow"
          >
            Learn More
            <svg
